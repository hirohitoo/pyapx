...
pvnames =["SES:Area","APX:HPC01","APX:HPC100","APX:Theater","APX:CellIn_RV","APX:CellIn_RV2","APX:CellIn_RV3","APX:CellOut_RV",
"APX:CellIn_MV","APX:CellIn_MV2","APX:CellIn_MV3","APX:CellOut_MV","APX:GAS",
"BL132:Io","SPEC:mono132","SPEC:gap","SPEC:epu","BL132:Iz","BL132:Id","BL132:Is","BL132:m1yaw_2_LVDT","BL132:m2pit_2_LVDT",
...
pvnames0 =["Time","TimeStr"]
pvnames0=pvnames0+pvnames
print('132pylog')
#print(pvnames0)
filename1 = '/com/Py/data/'+'l'+datetime.datetime.now().strftime("%Y%m%d%H%M%S")+'.csv'
with open(filename1,"a",newline='') as g:
     header=pvnames0+pvnames
     print(header,end='\r')
...
#    try:
        ...
        pvs =[time.time(),datetime.datetime.now().strftime("%Y%m%d%H%M%S")]
