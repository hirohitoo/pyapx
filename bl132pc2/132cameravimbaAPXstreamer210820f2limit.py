...
class Camera(object):
    ...
    def frames():
        ...
        # Draw time stamp
                    ...
                    imagevstack1203s = cv2.putText(imagevstack1203,dt_string,(30,30),cv2.FONT_HERSHEY_SIMPLEX,1,(255, 0, 0),1,cv2.LINE_AA)
        #ret,frame=raw.read()    
...
#    default_limits=["300 per day", "3/minute"]
#)
...
#        frame0=cv2.putText(frame_np, text=date_time, org=(2,2),fontFace= cv2.FONT_HERSHEY_SIMPLEX, fontScale=1, color=(0,0,0),thickness=1, lineType=cv2.LINE_AA)
